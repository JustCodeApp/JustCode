...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'sql4.freesqldatabase.com', 'port' => 3306, 'dbname' => 'sql4103129', 'user' => 'sql4103129', 'password' => 'hlaaPbIY9R', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/JustCode/Bundle/actividadesBundle/Resources/config/doctrine') => 'JustCode\\Bundle\\actividadesBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'JustCode\\Bundle\\actividadesBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('JustCodeactividadesBundle' => 'JustCode\\Bundle\\actividadesBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fcf83f2d455813ab4ee915aa42265c5b092c3a10fe0e99b7edfbe5b891df86e0');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/JustCode/Bundle/actividadesBundle/Resources/views'), 'JustCodeactividades');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e0694ef97c2b8a6da787a753d7dca71576c131c4');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56ab39f0a6ee88.28355856')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'JustCodeactividadesBundle' => 'JustCode\\Bundle\\actividadesBundle\\JustCodeactividadesBundle',
            ...
            'database_host' => 'sql4.freesqldatabase.com',
            'database_port' => 3306,
            'database_name' => 'sql4103129',
            'database_user' => 'sql4103129',
            'database_password' => 'hlaaPbIY9R',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'e0694ef97c2b8a6da787a753d7dca71576c131c4',
            'locale' => 'en',
            ...
            'kernel.secret' => 'e0694ef97c2b8a6da787a753d7dca71576c131c4',
